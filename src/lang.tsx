...
const en = {
    ...
    amazon: 'Amazon',
    seattle: 'Seattle, WA',
    amazonDesc: 'Incoming SDE intern for summer 2022',
    ...
    youtube: 'YouTube',
    instagram: 'Instagram',
    herMost: 'Her Most Beautiful Smile from Ruroruni Kenshin',
    kakurenbo: 'Kakurenbo by Yuuri',
...
const jp = {
    ...
    welcome: 'ようこそ！',
    aboutme: '初めまして！浅沼真樹と申します。ジョージア工科大学でコンピューターサイエンスを勉強している大学4年生です。ソフトウェア開発に取り組んでいない時はソロギターを弾いたり、エアロプレスを使って色々な国からの豆を使ってコーヒーを淹れて過ごしています☕',
    shizuoka: '静岡',
    takenoko: '竹の子狩り',
    snow: '雪',
    gtdl: 'ドラムライン',
    ...
    amazon: 'Amazon',
    seattle: 'シアトル、ワシントン州',
    amazonDesc: '2022年の夏にインターンする予定です。',
    ...
    youtube: 'YouTube',
    instagram: 'Instagram',
    herMost: 'Her Most Beautiful Smile - るろうに剣心より',
    kakurenbo: 'かくれんぼ - 優里',
